...
- 旧形式の最終出現は 2026-07-31(確認時点の11日前)で、リリースの新旧とは無関係に
...
次の確認方法で、**直近およそ1ヶ月**旧形式の出現がなければ削除してよい。
...
`latest_old` のセッション日時が今日から見て約1ヶ月以上前なら削除条件を満たす。
1ヶ月未満、あるいは0件でも観測期間自体が1ヶ月に満たない場合は様子見を続ける。
